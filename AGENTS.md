...
- Saving in the hub does not authorize a child app. Every child app must require an explicit use action and independently verify access to its target repository.
